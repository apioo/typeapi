    ...
    <div class="columns">
      ...
      <div class="column is-4">
        <aside class="menu">
          ...
          <ul class="menu-list">
            <li><a href="https://github.com/apioo/typeapi" class="panel-block">TypeAPI</a></li>
            <li><a href="https://github.com/apioo/typeschema" class="panel-block">TypeSchema</a></li>
            <li><a href="https://github.com/apioo/sdkgen-cli" class="panel-block">SDKgen CLI</a></li>
          </ul>
        </aside>
      </div>
      <div class="column is-4">
