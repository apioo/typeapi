...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo $url; ?>">TypeAPI</a> / <a href="<?php echo $router->getAbsolutePath([\App\Controller\Generator::class, 'show']); ?>">Generator</a> / <?php echo $typeName; ?></li>
  </ol>
</nav>

<div class="container-fluid">
  <h1 class="display-4"><?php echo $typeName; ?> Generator</h1>
  <div class="row">
    <div class="col-6">
    ...
    <div class="col-6">
      ...
      <form id="downloadForm" method="post" action="<?php echo $router->getAbsolutePath([\App\Controller\Generator::class, 'download'], ['type' => $type]); ?>">
        ...
        <a href="https://github.com/apioo/typeapi/discussions/new?category=<?php echo $type; ?>" class="btn btn-secondary">Report Issue</a>
      </form>
      <hr>
